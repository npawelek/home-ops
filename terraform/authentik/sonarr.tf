resource "authentik_provider_proxy" "sonarr" {
  ...
  external_host                = "https://sonarr.${var.domain}"
...
resource "authentik_application" "sonarr" {
  ...
  meta_launch_url    = "https://sonarr.${var.domain}"
...
resource "authentik_policy_binding" "sonarr_admins_access" {
